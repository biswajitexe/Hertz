...
function run(interaction, database) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, modLogger_1.logAction)(interaction.guild, user.user, interaction.user, 'TIMEOUT', reason, database, extraInfo);
            const successEmbed = (0, embedUtils_1.createSuccessEmbed)(interaction.user, `**Timed Out ${user.user.tag}**`)
