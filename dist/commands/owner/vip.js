    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (subcommand === 'add') {
            ...
            if (botConfig.vipUsers.includes(targetUser.id)) {
                return interaction.reply((0, componentV2_1.createErrorV2)(`**${targetUser.tag}** is already a **VIP**.`).toPayload());
            }
        ...
        if (subcommand === 'remove') {
            const targetUser = interaction.options.getUser('user', true);
            if (!botConfig.vipUsers.includes(targetUser.id)) {
                return interaction.reply((0, componentV2_1.createErrorV2)(`**${targetUser.tag}** is not a **VIP**.`).toPayload());
            }
        ...
        if (subcommand === 'list') {
            ...
            if (users.length === 0)
                return interaction.reply((0, componentV2_1.createWarningV2)('No VIPs found.').toPayload());
